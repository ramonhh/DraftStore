...
<html lang="en">
  <head>
    ...
    <![endif]-->
    <link href="resources/css/cadastrarProdutos.css" type="text/css" rel="stylesheet">
  </head>
  <body>
    <header>
    ...
    <div class="row">
      ...
      <div class="col-sm-9">
        ...
        <div class="form">
          ...
          <p class="comboBox" id="tipoDoProduto">
          ...
          <p class="comboBox" id="fornecedor">
          ...
          <p class="textField custo">
            <label for="custo"> Custo </label>
            <input id="custo" type="text" name="custo" class="inputCusto">
          </p>
           <p class="textField number">
            <label class="lucro" for="lucro"> % de lucro: </label>
            <input type="number" min="1" step="0.1" value="10" id="lucro"> 
          </p>
          <p class="textField">
            <label for="precoVenda"> Preço de Venda </label>
            <input id="precoVenda" type="text">
          </p>
          <p class="textField">
            <label for="precoPrevisto"> Preço previsto para Venda: </label>
            <input id="precoPrevisto" type="text">
          </p>
